...
import com.example.aplicacion.Chat_note;
...
public class NchatFragment extends Fragment {
    ...
    private NchatViewModel mViewModel;

    private Unbinder unbinder;

    static NchatFragment instance;

    public static NchatFragment getInstance()
    {
        return instance == null ? new NchatFragment() : instance;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View itemView =  inflater.inflate(R.layout.fragment_nchat, container, false);
        initView(itemView);
        loadChatList();
        return itemView;
    }
    ...
    private void loadChatList() {
        ...
        adapter = new FirebaseRecyclerAdapter<ChatInfoModel, NChatInfoHolder>(options) {
            @NonNull
            @Override
            public NChatInfoHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                return null;
            }
       ...
       //     @Override
         //   public ChatInfoHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
           //     View itemView = LayoutInflater.from(parent.getContext())
            ...
            @Override
            protected void onBindViewHolder(@NonNull NChatInfoHolder holder, int position, @NonNull ChatInfoModel model) {
                                ...
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        if(snapshot.exists())
                                        {
                                            ...
                                            startActivity(new Intent(getContext(), Chat_note.class));
                                        }
                                    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(NchatViewModel.class);
